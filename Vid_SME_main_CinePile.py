...
data_list = {
    "train": ("./video_json/cinepine_mia.json", f"./video_json/videos", "video"),
    "TR": ("./video_json/topic_reasoning.json", f"./video_json/videos", "video"),
    "AR": ("./video_json/anomaly_reco.json", f"./video_json/videos", "video"),
    "NQA": ("./video_json/needleQA.json", f"./video_json/videos", "video"),
    "ER": ("./video_json/ego.json", f"./video_json/videos", "video"),
    "PQA": ("./video_json/plotQA.json", f"./video_json/videos", "video"),
    "AO": ("./video_json/order.json", f"./video_json/videos", "video"),
    "AC": ("./video_json/count.json", f"./video_json/videos", "video"),
    "SQA": ("./video_json/sportsQA.json", f"./video_json/videos", "video"),
    "TQA": ("./video_json/tutorialQA.json", f"./video_json/videos", "video")    
    }
...
for max_frames_num in frame_list:
    model_type = f"vidsme_cinepile_frm{max_frames_num}"
    save_path = f"./statistics_{model_type}"

    dataset = MLVU(data_dir, data_list)
    torch.manual_seed(0)
    model_path = "./checkpoints/Vid-SME-CinePile-7B"
    ...
    brightness_var_list = []
    q_file = f"q_values_cinepile_frame_{max_frames_num}.npy"
    r_file = f"r_values_cinepile_frame_{max_frames_num}.npy"
